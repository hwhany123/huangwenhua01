...
class StoreCategoryDetailSerializer(serializers.ModelSerializer):
    """给分类详情的嵌套序列化器"""
...
class CategoryDetailSerializer(serializers.ModelSerializer):
    """分类详情"""
    Stores = StoreCategoryDetailSerializer(many=True, read_only=True)
...
class StoreBaseSerializer(serializers.HyperlinkedModelSerializer):
    """
    文章序列化器父类
    """
