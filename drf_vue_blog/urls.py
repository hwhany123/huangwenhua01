...
router.register(r'store_category', views_store.CategoryViewSet,basename='store_category')
router.register(r'tag', views.TagViewSet)
router.register(r'store_tag', views_store.TagViewSet,basename='store_tag')
router.register(r'avatar', views.AvatarViewSet)
router.register(r'store_avatar', views_store.AvatarViewSet,basename='store_avatar')
